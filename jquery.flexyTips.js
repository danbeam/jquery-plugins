			...
			return $( this ).each( function( )
			{
				...
				(
					function( )
					{
						...
						// add the CSS to the cotainer and set the id to flexyLink
						...
						settings.onBeforeShow( document.body.appendChild( container ) );
						...
						switch( direction )
						{
							case "left"	: var animation = { "width" : tipWidth + "px", "left" : "-=" + tipWidth + "px" };	break;
							case "right"	: var animation = { "width" : tipWidth + "px" };					break;
							case "up"	: var animation = { "height" : tipHeight + "px", "top" : "-=" + tipHeight + "px" };	break;
							case "down"	: var animation = { "height" : tipHeight + "px" };					break;
						}
					...
					function( )
					{
						...
						// trigger the onHideStart handler event
						settings.onBeforeHide( container );

						switch( settings[ "direction" ] )
						{
							case "left"	: var hideAnimation = { "width" : "hide", "left" : "+=" + tipWidth + "px" };	break;
							case "right"	: var hideAnimation = { "width" : "hide" };					break;
							case "up"	: var hideAnimation = { "height" : "hide", "top" : "+=" + tipHeight + "px" };	break;
							case "down"	: var hideAnimation = { "height" : "hide" };					break;
							default		: var hideAnimation = { };							break;
						}
